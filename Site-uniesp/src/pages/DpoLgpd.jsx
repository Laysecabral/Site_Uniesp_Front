  ...
  return (
    <Container className="py-4">
        ...
        <Card className="mb-4 shadow-sm">
         ...
         <Row className="g-4"> {/*Espaço entre os cards*/}
            ...
            <Col md={4}>
                ...
                <Card.Body>
                    ...
                    <Card.Text>A conformidade com a LGPD é essencial para proteger a privacidade dos dados e evitar penalidades legais.</Card.Text>
                </Card.Body>
